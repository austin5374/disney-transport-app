...
// Bus ride times come from busRideMinutes() in resortBus.ts
//
// 117 of the 196 bus legs here were exactly 30 minutes: a clamp left behind
...
//
// 110 of those legs were also duplicates: a single-leg route whose exact trip
// resortBus.ts already generates from the distance model, and which won
// anyway because directRoutes prefers a hand-authored entry. The flat 30 was
...
export const ALL_ROUTES: Route[] = [
...

  {
    ...
    legs: [
      { mode: 'monorail_express', from: 'MK', to: 'TTC', rideMinutes: 8, accessible: true, tip: 'Exit at TTC and follow signs to EPCOT Monorail. It\'s a short walk across the platform.' },
      { mode: 'monorail_epcot', from: 'TTC', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 2, tip: 'EPCOT Monorail drops you at the main entrance to EPCOT.' },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'MK', to: 'EP', rideMinutes: 15, accessible: true }],
...

  {
    ...
    legs: [{ mode: 'bus', from: 'MK', to: 'HS', rideMinutes: 25, accessible: true, tip: 'Bus stop is outside the park gates, Transportation Hub area.' }],
...

  {
    ...
    legs: [{ mode: 'bus', from: 'MK', to: 'AK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,40], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'MK', to: 'AK', rideMinutes: 20, accessible: true }],
...

  {
    ...
    legs: [{ mode: 'bus', from: 'MK', to: 'DS', rideMinutes: 20, accessible: true, tip: 'Direct park-to-Disney Springs bus, no transfer needed. Starts running mid-afternoon.' }],
...

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'MK', to: 'TL', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'MK', to: 'BB', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'walk', from: 'MK', to: 'GF', rideMinutes: 14, accessible: true, tip: 'Scenic path along Seven Seas Lagoon. Usually faster than any transit option.' }],
    totalRideMinutes: 14, tags: ['walk_only'],
  },
  {
    id: 'mk-gf-watertaxi',
    from: 'MK', to: 'GF', name: 'Gold Flag Water Taxi to Grand Floridian',
    legs: [{ mode: 'water_taxi_gold', from: 'MK', to: 'GF', rideMinutes: 8, accessible: false, tip: 'Boats depart from the MK boat dock. Gold Flag stops at GF then Poly.' }],
...

  {
    ...
    legs: [{ mode: 'walk', from: 'MK', to: 'POLY', rideMinutes: 22, accessible: true, tip: 'Walk via GF then the path to Poly. Longer walk but no wait.' }],
    totalRideMinutes: 22, tags: ['walk_only'],
  },
  {
    id: 'mk-poly-watertaxi',
    from: 'MK', to: 'POLY', name: 'Gold Flag Water Taxi to Polynesian',
    legs: [{ mode: 'water_taxi_gold', from: 'MK', to: 'POLY', rideMinutes: 15, accessible: false, tip: 'Gold Flag stops at GF first, then continues to Polynesian. About 8 min per stop.' }],
...

  {
    ...
    legs: [{ mode: 'water_taxi_red', from: 'MK', to: 'WL', rideMinutes: 8, accessible: true, tip: 'Drops off right at the WL boat dock. Scenic, relaxing option.' }],
    totalRideMinutes: 8, tags: ['water', 'scenic'],
  },
  {
    id: 'mk-wl-bus',
    from: 'MK', to: 'WL', name: 'Bus from Magic Kingdom to Wilderness Lodge',
    legs: [{ mode: 'bus', from: 'MK', to: 'WL', rideMinutes: 7, accessible: true, tip: 'Bus drops directly at WL, not TTC. A fast and reliable non-water option.' }],
    totalRideMinutes: 7, totalRideRange: [7,27], tags: [],
  },

  {
    id: 'mk-fw-watertaxi',
    from: 'MK', to: 'FW', name: 'Green Flag Water Taxi to Fort Wilderness',
    legs: [{ mode: 'water_taxi_green', from: 'MK', to: 'FW', rideMinutes: 13, accessible: true, tip: 'Takes you to FW marina. From there, take the internal FW bus to your campsite.' }],
...

  {
    ...
    legs: [{ mode: 'bus', from: 'MK', to: 'YC', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'mk-bc-bus',
    from: 'MK', to: 'BC', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'BC', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'mk-bwi-bus',
    from: 'MK', to: 'BWI', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'BWI', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'MK', to: 'CBR', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'mk-akl-bus',
    from: 'MK', to: 'AKL', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'AKL', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'mk-cor-bus',
    from: 'MK', to: 'COR', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'COR', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'mk-pofq-bus',
    from: 'MK', to: 'POFQ', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'POFQ', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'mk-por-bus',
    from: 'MK', to: 'POR', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'POR', rideMinutes: 25, accessible: true }],
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'MK', to: 'ASMu', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
  {
    id: 'mk-ass-bus',
    from: 'MK', to: 'ASS', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'ASS', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
  {
    id: 'mk-pop-bus',
    from: 'MK', to: 'POP', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'POP', rideMinutes: 28, accessible: true }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  {
    id: 'mk-aoa-bus',
    from: 'MK', to: 'AOA', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'AOA', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
  {
    id: 'mk-riv-bus',
    from: 'MK', to: 'RIV', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'RIV', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'mk-okw-bus',
    from: 'MK', to: 'OKW', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'OKW', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'mk-ss-bus',
    from: 'MK', to: 'SS', name: 'Bus from Magic Kingdom',
    legs: [{ mode: 'bus', from: 'MK', to: 'SS', rideMinutes: 27, accessible: true }],
    totalRideMinutes: 27, totalRideRange: [27,47], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'walk', from: 'TTC', to: 'POLY', rideMinutes: 6, accessible: true, tip: 'Always walk this one. Polynesian is the closest thing to TTC. No monorail needed.' }],
...

  {
    ...
    legs: [
      { mode: 'monorail_epcot', from: 'TTC', to: 'EP', rideMinutes: 12, accessible: true, tip: 'Requires EPCOT park access or International Gateway entrance.' },
      { mode: 'walk', from: 'EP', to: 'YC', rideMinutes: 9, accessible: true, walkMinutes: 0, tip: 'Exit EPCOT via International Gateway (between UK and France). Yacht Club is a 9-min walk.' },
    ],
  ...
  },
  {
    ...
    legs: [
      { mode: 'monorail_epcot', from: 'TTC', to: 'EP', rideMinutes: 12, accessible: true },
      { mode: 'walk', from: 'EP', to: 'SW', rideMinutes: 12, accessible: true, walkMinutes: 0, tip: 'Exit via International Gateway, walk along Crescent Lake path to Swan.' },
    ],
  ...
  },
  {
    ...
    legs: [
      ...
      { mode: 'bus', from: 'MK', to: 'WL', rideMinutes: 7, accessible: true, walkMinutes: 3, tip: 'Exit MK, go to Transportation Hub, take WL bus. Drops at WL gates directly.' },
    ],
...

  {
    ...
    legs: [
      { mode: 'monorail_epcot', from: 'EP', to: 'TTC', rideMinutes: 12, accessible: true, tip: 'Transfer at TTC, a short walk between monorail platforms.' },
      { mode: 'monorail_express', from: 'TTC', to: 'MK', rideMinutes: 8, accessible: true, walkMinutes: 2 },
    ],
    totalRideMinutes: 20, tags: ['transfer'],
  },
  {
    ...
    legs: [
      ...
      { mode: 'ferry_ttc_mk', from: 'TTC', to: 'MK', rideMinutes: 12, accessible: true, walkMinutes: 3, tip: 'Scenic ferry option. Boards at TTC boat dock.' },
    ],
    totalRideMinutes: 24, tags: ['water', 'transfer', 'scenic'],
  },
  {
    id: 'ep-mk-minnie',
    from: 'EP', to: 'MK', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'EP', to: 'MK', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, tags: [],
  },

  {
    ...
    legs: [
      { mode: 'skyliner', from: 'EP', to: 'CBR', rideMinutes: 12, accessible: true, tip: 'Board at EPCOT International Gateway (between UK and France pavilions).' },
      { mode: 'skyliner', from: 'CBR', to: 'HS', rideMinutes: 5, accessible: true, walkMinutes: 3, tip: 'Short walk between Skyliner lines at Caribbean Beach hub.' },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'friendship_boat', from: 'EP', to: 'HS', rideMinutes: 35, accessible: true, tip: 'Longest but most scenic option. Stops at BWI, YC/BC, Swan/Dolphin before HS.' }],
    totalRideMinutes: 35, tags: ['water', 'scenic'],
  },
  {
    id: 'ep-hs-bus',
    from: 'EP', to: 'HS', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'HS', rideMinutes: 25, accessible: true, tip: 'Skyliner via Caribbean Beach is usually faster. This is the backup Disney transit option.' }],
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'EP', to: 'HS', rideMinutes: 12, accessible: true }],
...

  {
    ...
    legs: [{ mode: 'bus', from: 'EP', to: 'AK', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
  {
...

  {
    ...
    legs: [{ mode: 'bus', from: 'EP', to: 'DS', rideMinutes: 20, accessible: true, tip: 'Direct park-to-Disney Springs bus, no transfer needed. Starts running mid-afternoon.' }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
    timeRestriction: 'after_4pm_only',
  },
  {
...

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'EP', to: 'TL', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, tags: [],
  },

  {
    ...
    legs: [
      { mode: 'bus', from: 'EP', to: 'AK', rideMinutes: 17, accessible: true },
      { mode: 'bus', from: 'AK', to: 'BB', rideMinutes: 15, accessible: true, walkMinutes: 5 },
    ],
    totalRideMinutes: 32, totalRideRange: [32,57], tags: ['transfer'],
  },
  {
    id: 'ep-bb-minnie',
    from: 'EP', to: 'BB', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'EP', to: 'BB', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'walk', from: 'EP', to: 'YC', rideMinutes: 9, accessible: true, tip: 'Exit via International Gateway, walk along Crescent Lake. Fastest option.' }],
    totalRideMinutes: 9, tags: ['walk_only'],
  },
  {
    id: 'ep-yc-boat',
    from: 'EP', to: 'YC', name: 'Friendship Boat to Yacht Club',
    legs: [{ mode: 'friendship_boat', from: 'EP', to: 'YC', rideMinutes: 20, accessible: true, tip: 'Stops at BWI first, then YC/BC. Walking is faster.' }],
    totalRideMinutes: 20, tags: ['water', 'scenic'],
  },
  {
    id: 'ep-bc-walk',
    from: 'EP', to: 'BC', name: 'Walk via International Gateway (~9 min)',
    legs: [{ mode: 'walk', from: 'EP', to: 'BC', rideMinutes: 9, accessible: true, tip: 'Exit via International Gateway. Beach Club is right there.' }],
    totalRideMinutes: 9, tags: ['walk_only'],
  },

  {
    ...
    legs: [{ mode: 'walk', from: 'EP', to: 'SW', rideMinutes: 12, accessible: true, tip: 'Exit via International Gateway, walk along Crescent Lake path.' }],
    totalRideMinutes: 12, tags: ['walk_only'],
  },
  {
    id: 'ep-do-walk',
    from: 'EP', to: 'DO', name: 'Walk via International Gateway (~12 min)',
    legs: [{ mode: 'walk', from: 'EP', to: 'DO', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, tags: ['walk_only'],
  },

  {
    ...
    legs: [{ mode: 'skyliner', from: 'EP', to: 'CBR', rideMinutes: 12, accessible: true, tip: 'Board at International Gateway station. Direct to CBR (passes Riviera but no stop needed).' }],
...

  {
    ...
    legs: [{ mode: 'skyliner', from: 'EP', to: 'RIV', rideMinutes: 9, accessible: true, tip: 'Board at International Gateway. Riviera is the first Skyliner stop from EPCOT.' }],
...

  {
    ...
    legs: [
      { mode: 'skyliner', from: 'EP', to: 'CBR', rideMinutes: 12, accessible: true, tip: 'Board at International Gateway station.' },
      { mode: 'skyliner', from: 'CBR', to: 'POP', rideMinutes: 5, accessible: true, walkMinutes: 3, tip: 'Short transfer at Caribbean Beach hub.' },
    ],
    totalRideMinutes: 17, tags: ['transfer', 'scenic'],
  },
  {
    ...
    legs: [
      { mode: 'skyliner', from: 'EP', to: 'CBR', rideMinutes: 12, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'AOA', rideMinutes: 5, accessible: true, walkMinutes: 3 },
    ],
    totalRideMinutes: 17, tags: ['transfer', 'scenic'],
  },
  ...
  },
  {
    ...
    legs: [
      { mode: 'monorail_epcot', from: 'EP', to: 'TTC', rideMinutes: 12, accessible: true },
      { mode: 'monorail_resort', from: 'TTC', to: 'GF', rideMinutes: 6, accessible: true, walkMinutes: 2, tip: 'Resort Monorail: TTC→POLY→GF. Two stops in correct loop direction.' },
    ],
    totalRideMinutes: 18, tags: ['transfer'],
  },
  {
    ...
    legs: [
      { mode: 'monorail_epcot', from: 'EP', to: 'TTC', rideMinutes: 12, accessible: true },
      { mode: 'monorail_resort', from: 'TTC', to: 'CON', rideMinutes: 14, accessible: true, walkMinutes: 2, tip: 'Four stops in correct direction: TTC→POLY→GF→MK→CON.' },
    ],
    totalRideMinutes: 26, tags: ['transfer'],
  },
  {
    id: 'ep-con-minnie',
    from: 'EP', to: 'CON', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'EP', to: 'CON', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },
  {
    id: 'ep-wl-bus',
    from: 'EP', to: 'WL', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'WL', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: [],
  },
  {
    id: 'ep-fw-bus',
    from: 'EP', to: 'FW', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'FW', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: [],
  },
  {
    id: 'ep-akl-bus',
    from: 'EP', to: 'AKL', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'AKL', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'ep-cor-bus',
    from: 'EP', to: 'COR', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'COR', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'ep-pofq-bus',
    from: 'EP', to: 'POFQ', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'POFQ', rideMinutes: 14, accessible: true }],
    totalRideMinutes: 14, totalRideRange: [14,34], tags: [],
  },
  {
    id: 'ep-por-bus',
    from: 'EP', to: 'POR', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'POR', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'ep-asso-bus',
    from: 'EP', to: 'ASMo', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'ASMo', rideMinutes: 19, accessible: true }],
    totalRideMinutes: 19, totalRideRange: [19,39], tags: [],
  },
  {
    id: 'ep-pop-bus',
    from: 'EP', to: 'POP', name: 'Bus from EPCOT (alternative)',
    legs: [{ mode: 'bus', from: 'EP', to: 'POP', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, totalRideRange: [12,32], tags: [],
  },
  {
    id: 'ep-okw-bus',
    from: 'EP', to: 'OKW', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'OKW', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'ep-ss-bus',
    from: 'EP', to: 'SS', name: 'Bus from EPCOT',
    legs: [{ mode: 'bus', from: 'EP', to: 'SS', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
...

  {
    ...
    legs: [
      { mode: 'skyliner', from: 'HS', to: 'CBR', rideMinutes: 5, accessible: true, tip: 'Board at Hollywood Studios Skyliner station near the park entrance.' },
      { mode: 'skyliner', from: 'CBR', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 3, tip: 'Transfer at Caribbean Beach hub. Follow signs to the EPCOT line. Drops at International Gateway.' },
    ],
    totalRideMinutes: 17, tags: ['transfer', 'scenic'],
  },
  {
    ...
    legs: [{ mode: 'friendship_boat', from: 'HS', to: 'EP', rideMinutes: 35, accessible: true, tip: 'Stops at SW/DO, YC/BC, BWI before EPCOT International Gateway. Scenic but slow.' }],
    totalRideMinutes: 35, tags: ['water', 'scenic'],
  },
  {
    id: 'hs-ep-bus',
    from: 'HS', to: 'EP', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'EP', rideMinutes: 25, accessible: true, tip: 'Skyliner via Caribbean Beach is usually faster. This is the backup Disney transit option.' }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'HS', to: 'EP', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'HS', to: 'MK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
...

  {
    ...
    legs: [{ mode: 'bus', from: 'HS', to: 'AK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'HS', to: 'AK', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'HS', to: 'DS', rideMinutes: 20, accessible: true, tip: 'Direct park-to-Disney Springs bus, no transfer needed. Starts running mid-afternoon.' }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
    timeRestriction: 'after_4pm_only',
  },
  {
...

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'HS', to: 'TL', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, tags: [],
  },

  {
    ...
    legs: [
      { mode: 'bus', from: 'HS', to: 'AK', rideMinutes: 25, accessible: true },
      { mode: 'bus', from: 'AK', to: 'BB', rideMinutes: 15, accessible: true, walkMinutes: 5 },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'HS', to: 'BB', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },
  ...
  },
  {
    ...
    legs: [{ mode: 'friendship_boat', from: 'HS', to: 'YC', rideMinutes: 17, accessible: true, tip: 'First stop after SW/DO from Hollywood Studios direction.' }],
...

  {
    ...
    legs: [{ mode: 'walk', from: 'HS', to: 'SW', rideMinutes: 11, accessible: true, tip: 'Most direct walk from HS entrance. Cross the bridge toward Swan.' }],
    totalRideMinutes: 11, tags: ['walk_only'],
  },
  {
    id: 'hs-sw-boat',
    from: 'HS', to: 'SW', name: 'Friendship Boat to Swan',
    legs: [{ mode: 'friendship_boat', from: 'HS', to: 'SW', rideMinutes: 10, accessible: true, tip: 'First Friendship Boat stop from HS.' }],
    totalRideMinutes: 10, tags: ['water', 'scenic'],
  },
  {
    id: 'hs-do-walk',
    from: 'HS', to: 'DO', name: 'Walk to Dolphin (~11 min)',
    legs: [{ mode: 'walk', from: 'HS', to: 'DO', rideMinutes: 11, accessible: true }],
    totalRideMinutes: 11, tags: ['walk_only'],
  },

  {
    ...
    legs: [{ mode: 'skyliner', from: 'HS', to: 'CBR', rideMinutes: 5, accessible: true, tip: 'Direct Skyliner from HS station. Fastest option to CBR.' }],
  ...
  },
  {
    ...
    legs: [
      { mode: 'skyliner', from: 'HS', to: 'CBR', rideMinutes: 5, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'RIV', rideMinutes: 4, accessible: true, walkMinutes: 3 },
    ],
  ...
  },
  {
    ...
    legs: [
      { mode: 'skyliner', from: 'HS', to: 'CBR', rideMinutes: 5, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'POP', rideMinutes: 5, accessible: true, walkMinutes: 3 },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'HS', to: 'CON', rideMinutes: 23, accessible: true }],
    totalRideMinutes: 23, totalRideRange: [23,43], tags: [],
  },
  {
    id: 'hs-gf-bus',
    from: 'HS', to: 'GF', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'GF', rideMinutes: 23, accessible: true }],
    totalRideMinutes: 23, totalRideRange: [23,43], tags: [],
  },
  {
    id: 'hs-poly-bus',
    from: 'HS', to: 'POLY', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'POLY', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'hs-wl-bus',
    from: 'HS', to: 'WL', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'WL', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'hs-fw-bus',
    from: 'HS', to: 'FW', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'FW', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, totalRideRange: [22,42], tags: [],
  },
  {
    id: 'hs-akl-bus',
    from: 'HS', to: 'AKL', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'AKL', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'hs-cor-bus',
    from: 'HS', to: 'COR', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'COR', rideMinutes: 10, accessible: true }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },
  {
    id: 'hs-pofq-bus',
    from: 'HS', to: 'POFQ', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'POFQ', rideMinutes: 19, accessible: true }],
    totalRideMinutes: 19, totalRideRange: [19,39], tags: [],
  },
  {
    id: 'hs-por-bus',
    from: 'HS', to: 'POR', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'POR', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: [],
  },
  {
    id: 'hs-asmo-bus',
    from: 'HS', to: 'ASMo', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'ASMo', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'hs-asmu-bus',
    from: 'HS', to: 'ASMu', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'ASMu', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, totalRideRange: [12,32], tags: [],
  },
  {
    id: 'hs-ass-bus',
    from: 'HS', to: 'ASS', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'ASS', rideMinutes: 11, accessible: true }],
    totalRideMinutes: 11, totalRideRange: [11,31], tags: [],
  },
  {
    id: 'hs-okw-bus',
    from: 'HS', to: 'OKW', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'OKW', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'hs-ss-bus',
    from: 'HS', to: 'SS', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'SS', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'hs-bc-bus',
    from: 'HS', to: 'BC', name: 'Bus from Hollywood Studios',
    legs: [{ mode: 'bus', from: 'HS', to: 'BC', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'bus', from: 'AK', to: 'MK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
...

  {
    ...
    legs: [{ mode: 'bus', from: 'AK', to: 'EP', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'AK', to: 'EP', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'AK', to: 'HS', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: ['time_restricted'],
    timeRestriction: 'after_10am',
    notes: 'Park-to-park buses run from 10am until about 1 hour after the later park\'s closing time (varies daily).',
  },
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'AK', to: 'DS', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'AK', to: 'BB', rideMinutes: 15, accessible: true, tip: 'Very close, direct bus. Most convenient water park access from AK.' }],
...

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'AK', to: 'TL', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'AK', to: 'AKL', rideMinutes: 10, accessible: true, tip: 'Short hop. Bus shared with Kidani Village.' }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'AK', to: 'COR', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, totalRideRange: [22,42], tags: [],
  },
  {
    id: 'ak-asmo-bus',
    from: 'AK', to: 'ASMo', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'ASMo', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, totalRideRange: [22,42], tags: [],
  },
  {
    id: 'ak-cbr-bus',
    from: 'AK', to: 'CBR', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'CBR', rideMinutes: 18, accessible: true }],
    totalRideMinutes: 18, totalRideRange: [18,38], tags: [],
  },
  {
    id: 'ak-pop-bus',
    from: 'AK', to: 'POP', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'POP', rideMinutes: 18, accessible: true }],
    totalRideMinutes: 18, totalRideRange: [18,38], tags: [],
  },
  {
    id: 'ak-yc-bus',
    from: 'AK', to: 'YC', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'YC', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },
  {
    id: 'ak-con-bus',
    from: 'AK', to: 'CON', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'CON', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'ak-pofq-bus',
    from: 'AK', to: 'POFQ', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'POFQ', rideMinutes: 27, accessible: true }],
    totalRideMinutes: 27, totalRideRange: [27,47], tags: [],
  },
  {
    id: 'ak-okw-bus',
    from: 'AK', to: 'OKW', name: 'Bus from Animal Kingdom',
    legs: [{ mode: 'bus', from: 'AK', to: 'OKW', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'DS', to: 'MK', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'DS', to: 'EP', rideMinutes: 20, accessible: true, tip: 'Direct Disney Springs-to-park bus, no transfer needed. Starts running mid-afternoon.' }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
    timeRestriction: 'after_4pm_only',
  },
  {
    ...
    legs: [
      { mode: 'bus', from: 'DS', to: 'CBR', rideMinutes: 20, accessible: true, tip: 'Before the direct Disney Springs bus starts running, CBR Skyliner is the smartest connection.' },
      { mode: 'skyliner', from: 'CBR', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 5, tip: 'Skyliner drops at EPCOT International Gateway.' },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'DS', to: 'EP', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'DS', to: 'HS', rideMinutes: 20, accessible: true, tip: 'Direct Disney Springs-to-park bus, no transfer needed. Starts running mid-afternoon.' }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
    timeRestriction: 'after_4pm_only',
  },
  {
    ...
    legs: [
      { mode: 'bus', from: 'DS', to: 'CBR', rideMinutes: 20, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'HS', rideMinutes: 5, accessible: true, walkMinutes: 5, tip: 'Skyliner drops at HS entrance. Very efficient connection.' },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'DS', to: 'HS', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'DS', to: 'AK', rideMinutes: 25, accessible: true, tip: 'Direct Disney Springs-to-park bus, no transfer needed. Starts running mid-afternoon.' }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
    timeRestriction: 'after_4pm_only',
  },
  {
...

  {
    ...
    legs: [{ mode: 'bus', from: 'DS', to: 'TL', rideMinutes: 10, accessible: true, tip: 'Most direct water park connection from Disney Springs.' }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },

  {
    ...
    legs: [{ mode: 'minnie_van', from: 'DS', to: 'BB', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, tags: [],
  },

  {
    ...
    legs: [{ mode: 'sassagoula_boat', from: 'DS', to: 'POFQ', rideMinutes: 15, accessible: true, tip: 'Purple flag boat. Scenic river cruise, slower than bus but relaxing.' }],
    totalRideMinutes: 15, tags: ['water', 'scenic'],
  },
  {
    id: 'ds-pofq-bus',
    from: 'DS', to: 'POFQ', name: 'Bus from Disney Springs to Port Orleans French Quarter',
    legs: [{ mode: 'bus', from: 'DS', to: 'POFQ', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },

  {
    ...
    legs: [{ mode: 'sassagoula_boat', from: 'DS', to: 'POR', rideMinutes: 20, accessible: true, tip: 'Yellow flag boat. Stops at POFQ first, then Riverside. Scenic option.' }],
    totalRideMinutes: 20, tags: ['water', 'scenic'],
  },
  {
    id: 'ds-por-bus',
    from: 'DS', to: 'POR', name: 'Bus from Disney Springs to Port Orleans Riverside',
    legs: [{ mode: 'bus', from: 'DS', to: 'POR', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },

  {
    ...
    legs: [{ mode: 'sassagoula_boat', from: 'DS', to: 'OKW', rideMinutes: 20, accessible: true, tip: 'Green flag boat. Scenic route through the Sassagoula waterway.' }],
    totalRideMinutes: 20, tags: ['water', 'scenic'],
  },
  {
    id: 'ds-okw-bus',
    from: 'DS', to: 'OKW', name: 'Bus from Disney Springs to Old Key West',
    legs: [{ mode: 'bus', from: 'DS', to: 'OKW', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },

  {
    ...
    legs: [{ mode: 'sassagoula_boat', from: 'DS', to: 'SS', rideMinutes: 15, accessible: true, tip: 'Blue flag, shortest Sassagoula run. SS is right next to DS.' }],
    totalRideMinutes: 15, tags: ['water', 'scenic'],
  },
  {
    id: 'ds-ss-walk',
    from: 'DS', to: 'SS', name: 'Walk to Saratoga Springs (~17 min)',
    legs: [{ mode: 'walk', from: 'DS', to: 'SS', rideMinutes: 17, accessible: true, tip: 'Saratoga Springs is adjacent to Disney Springs. Easy walk.' }],
    totalRideMinutes: 17, tags: ['walk_only'],
  },
  {
    id: 'ds-ss-bus',
    from: 'DS', to: 'SS', name: 'Bus from Disney Springs to Saratoga Springs',
    legs: [{ mode: 'bus', from: 'DS', to: 'SS', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },

  {
    ...
    legs: [{ mode: 'bus', from: 'DS', to: 'CBR', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    id: 'ds-con-bus',
    from: 'DS', to: 'CON', name: 'Bus from Disney Springs',
    legs: [{ mode: 'bus', from: 'DS', to: 'CON', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'ds-akl-bus',
    from: 'DS', to: 'AKL', name: 'Bus from Disney Springs',
    legs: [{ mode: 'bus', from: 'DS', to: 'AKL', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
  {
    id: 'ds-ttc-minnie',
    from: 'DS', to: 'TTC', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'DS', to: 'TTC', rideMinutes: 20, accessible: true, tip: 'No good Disney transit route from DS to TTC. Rideshare is best.' }],
    totalRideMinutes: 20, tags: [],
  },
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'TL', to: 'MK', rideMinutes: 25, accessible: true, tip: 'Strongly recommended. Disney transit to MK from TL is very slow (multiple transfers).' }],
    totalRideMinutes: 25, tags: [],
  },
  {
    id: 'tl-ep-via-ds-cbr',
    ...
    legs: [
      ...
      { mode: 'bus', from: 'DS', to: 'CBR', rideMinutes: 20, accessible: true, walkMinutes: 5 },
      { mode: 'skyliner', from: 'CBR', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 5 },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'TL', to: 'EP', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, tags: [],
  },
  {
    id: 'tl-bb-minnie',
    from: 'TL', to: 'BB', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'TL', to: 'BB', rideMinutes: 20, accessible: true, tip: 'No direct Disney bus between water parks. Minnie Van is the only practical option.' }],
    totalRideMinutes: 20, tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'bus', from: 'BB', to: 'AK', rideMinutes: 15, accessible: true, tip: 'Direct bus. AK is very close to Blizzard Beach.' }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },
  {
    id: 'bb-mk-via-ak',
    ...
    legs: [
      { mode: 'bus', from: 'BB', to: 'AK', rideMinutes: 15, accessible: true },
      { mode: 'bus', from: 'AK', to: 'MK', rideMinutes: 25, accessible: true, walkMinutes: 5 },
    ],
    totalRideMinutes: 40, totalRideRange: [40,65], tags: ['transfer'],
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'BB', to: 'MK', rideMinutes: 22, accessible: true }],
  ...
  },
  {
    ...
    legs: [
      { mode: 'bus', from: 'BB', to: 'AK', rideMinutes: 15, accessible: true },
      { mode: 'bus', from: 'AK', to: 'EP', rideMinutes: 17, accessible: true, walkMinutes: 5 },
    ],
    totalRideMinutes: 32, totalRideRange: [32,57], tags: ['transfer'],
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'BB', to: 'EP', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, tags: [],
  },
  {
    id: 'bb-hs-via-ak',
    ...
    legs: [
      { mode: 'bus', from: 'BB', to: 'AK', rideMinutes: 15, accessible: true },
      { mode: 'bus', from: 'AK', to: 'HS', rideMinutes: 25, accessible: true, walkMinutes: 5 },
    ],
    totalRideMinutes: 40, totalRideRange: [40,65], tags: ['transfer'],
  },
  {
    ...
    legs: [{ mode: 'minnie_van', from: 'BB', to: 'HS', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, tags: [],
  },
  {
    id: 'bb-ds-minnie',
    from: 'BB', to: 'DS', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'BB', to: 'DS', rideMinutes: 15, accessible: true, tip: 'No clean Disney transit route from BB to DS. Rideshare recommended.' }],
    totalRideMinutes: 15, tags: [],
  },
  {
    id: 'bb-tl-minnie',
    from: 'BB', to: 'TL', name: 'Minnie Van (Lyft)',
    legs: [{ mode: 'minnie_van', from: 'BB', to: 'TL', rideMinutes: 20, accessible: true, tip: 'No direct Disney bus between water parks.' }],
    totalRideMinutes: 20, tags: [],
  },
  ...
  },
  {
    ...
    legs: [{ mode: 'friendship_boat', from: 'BWI', to: 'EP', rideMinutes: 20, accessible: true, tip: 'Stops at YC/BC, SW/DO before reaching EPCOT IG. Walking is faster.' }],
    totalRideMinutes: 20, tags: ['water', 'scenic'],
  },
  {
    id: 'bwi-hs-walk',
  ...
  },
  {
    ...
    legs: [{ mode: 'friendship_boat', from: 'BWI', to: 'HS', rideMinutes: 27, accessible: true, tip: 'Goes BWI→SW/DO→HS. Walk is usually faster.' }],
    totalRideMinutes: 27, tags: ['water', 'scenic'],
  },
  {
    id: 'bwi-mk-bus',
    from: 'BWI', to: 'MK', name: 'Bus from Boardwalk Inn',
    legs: [{ mode: 'bus', from: 'BWI', to: 'MK', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'bwi-ak-bus',
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'BWI', to: 'DS', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'bwi-yc-walk',
    from: 'BWI', to: 'YC', name: 'Walk to Yacht Club (~7 min)',
    legs: [{ mode: 'walk', from: 'BWI', to: 'YC', rideMinutes: 7, accessible: true }],
    totalRideMinutes: 7, tags: ['walk_only'],
  },
  {
    id: 'bwi-sw-walk',
    from: 'BWI', to: 'SW', name: 'Walk to Swan (~12 min)',
    legs: [{ mode: 'walk', from: 'BWI', to: 'SW', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, tags: ['walk_only'],
  },
  {
    id: 'bwi-cbr-bus',
    from: 'BWI', to: 'CBR', name: 'Bus from Boardwalk Inn',
    legs: [{ mode: 'bus', from: 'BWI', to: 'CBR', rideMinutes: 10, accessible: true }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'walk', from: 'YC', to: 'EP', rideMinutes: 9, accessible: true, tip: 'Walk to International Gateway entrance between UK and France. Fastest option.' }],
    totalRideMinutes: 9, tags: ['walk_only'],
  },
  {
    id: 'yc-ep-boat',
    from: 'YC', to: 'EP', name: 'Friendship Boat to EPCOT',
    legs: [{ mode: 'friendship_boat', from: 'YC', to: 'EP', rideMinutes: 25, accessible: true, tip: 'Stops at BWI before EP. Walking is faster.' }],
    totalRideMinutes: 25, tags: ['water', 'scenic'],
  },
  {
    id: 'bc-ep-walk',
    from: 'BC', to: 'EP', name: 'Walk via International Gateway (~9 min)',
    legs: [{ mode: 'walk', from: 'BC', to: 'EP', rideMinutes: 9, accessible: true, tip: 'Beach Club is right at the International Gateway entrance.' }],
    totalRideMinutes: 9, tags: ['walk_only'],
  },
  {
    id: 'yc-hs-walk',
  ...
  },
  {
    ...
    legs: [{ mode: 'friendship_boat', from: 'YC', to: 'HS', rideMinutes: 22, accessible: true, tip: 'Stops at SW/DO, then HS. Similar time to walking.' }],
    totalRideMinutes: 22, tags: ['water', 'scenic'],
  },
  {
    id: 'yc-hs-bus',
    from: 'YC', to: 'HS', name: 'Bus from Yacht Club',
    legs: [{ mode: 'bus', from: 'YC', to: 'HS', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    id: 'yc-mk-bus',
    from: 'YC', to: 'MK', name: 'Bus from Yacht Club',
    legs: [{ mode: 'bus', from: 'YC', to: 'MK', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'yc-ak-bus',
    from: 'YC', to: 'AK', name: 'Bus from Yacht Club',
    legs: [{ mode: 'bus', from: 'YC', to: 'AK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    id: 'yc-ds-bus',
    from: 'YC', to: 'DS', name: 'Bus from Yacht Club',
    legs: [{ mode: 'bus', from: 'YC', to: 'DS', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },
  {
    id: 'yc-bwi-walk',
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'BC', to: 'MK', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'bc-ak-bus',
    from: 'BC', to: 'AK', name: 'Bus from Beach Club',
    legs: [{ mode: 'bus', from: 'BC', to: 'AK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'walk', from: 'SW', to: 'EP', rideMinutes: 12, accessible: true, tip: 'Walk around Crescent Lake toward EPCOT International Gateway. Fastest option.' }],
    totalRideMinutes: 12, tags: ['walk_only'],
  },
  {
    id: 'sw-ep-boat',
    from: 'SW', to: 'EP', name: 'Friendship Boat to EPCOT',
    legs: [{ mode: 'friendship_boat', from: 'SW', to: 'EP', rideMinutes: 27, accessible: true, tip: 'Stops at BWI, YC/BC before EPCOT IG. Walking is faster.' }],
    totalRideMinutes: 27, tags: ['water', 'scenic'],
  },
  {
    id: 'do-ep-walk',
    from: 'DO', to: 'EP', name: 'Walk via Crescent Lake (~12 min)',
    legs: [{ mode: 'walk', from: 'DO', to: 'EP', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, tags: ['walk_only'],
  },
  {
    id: 'do-ep-boat',
  ...
  },
  {
    ...
    legs: [{ mode: 'walk', from: 'SW', to: 'HS', rideMinutes: 11, accessible: true, tip: 'Most direct walk from Swan. Cross the bridge, HS entrance is close.' }],
    totalRideMinutes: 11, tags: ['walk_only'],
  },
  {
    id: 'sw-hs-boat',
    from: 'SW', to: 'HS', name: 'Friendship Boat to Hollywood Studios',
    legs: [{ mode: 'friendship_boat', from: 'SW', to: 'HS', rideMinutes: 12, accessible: true, tip: 'First Friendship Boat stop heading toward HS.' }],
    totalRideMinutes: 12, tags: ['water', 'scenic'],
  },
  {
    id: 'do-hs-walk',
...

{
  ...
  },
  {
    ...
    legs: [{ mode: 'walk', from: 'SW', to: 'YC', rideMinutes: 7, accessible: true }],
    totalRideMinutes: 7, tags: ['walk_only'],
  },
...

  {
    ...
    legs: [{ mode: 'skyliner', from: 'CBR', to: 'EP', rideMinutes: 12, accessible: true, tip: 'Direct Skyliner from CBR hub. Arrives at EPCOT International Gateway.' }],
    totalRideMinutes: 12, tags: ['scenic'],
  },
  {
    id: 'cbr-hs-skyliner',
    from: 'CBR', to: 'HS', name: 'Skyliner to Hollywood Studios',
    legs: [{ mode: 'skyliner', from: 'CBR', to: 'HS', rideMinutes: 5, accessible: true, tip: 'Direct and fastest. Skyliner arrives at HS entrance.' }],
    totalRideMinutes: 5, tags: ['scenic'],
  },
  {
    id: 'cbr-riv-skyliner',
    from: 'CBR', to: 'RIV', name: 'Skyliner to Riviera Resort',
    legs: [{ mode: 'skyliner', from: 'CBR', to: 'RIV', rideMinutes: 4, accessible: true }],
    totalRideMinutes: 4, tags: ['scenic'],
  },
  {
    id: 'cbr-pop-skyliner',
    from: 'CBR', to: 'POP', name: 'Skyliner to Pop Century Resort',
    legs: [{ mode: 'skyliner', from: 'CBR', to: 'POP', rideMinutes: 4, accessible: true }],
    totalRideMinutes: 4, tags: ['scenic'],
  },
  {
    id: 'cbr-aoa-skyliner',
    from: 'CBR', to: 'AOA', name: 'Skyliner to Art of Animation Resort',
    legs: [{ mode: 'skyliner', from: 'CBR', to: 'AOA', rideMinutes: 5, accessible: true }],
    totalRideMinutes: 5, tags: ['scenic'],
  },
  {
    id: 'cbr-mk-bus',
    from: 'CBR', to: 'MK', name: 'Bus from Caribbean Beach Resort',
    legs: [{ mode: 'bus', from: 'CBR', to: 'MK', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'cbr-ak-bus',
    from: 'CBR', to: 'AK', name: 'Bus from Caribbean Beach Resort',
    legs: [{ mode: 'bus', from: 'CBR', to: 'AK', rideMinutes: 18, accessible: true }],
    totalRideMinutes: 18, totalRideRange: [18,38], tags: [],
  },
  {
    id: 'cbr-ds-bus',
    from: 'CBR', to: 'DS', name: 'Bus from Caribbean Beach Resort',
    legs: [{ mode: 'bus', from: 'CBR', to: 'DS', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    ...
    legs: [
      ...
      { mode: 'walk', from: 'EP', to: 'YC', rideMinutes: 9, accessible: true, walkMinutes: 0, tip: 'Exit EPCOT via International Gateway; walk along Crescent Lake.' },
    ],
...

  {
    ...
    legs: [{ mode: 'skyliner', from: 'RIV', to: 'EP', rideMinutes: 9, accessible: true, tip: 'Direct and fast. Arrives at EPCOT International Gateway.' }],
    totalRideMinutes: 9, tags: ['scenic'],
  },
  {
    id: 'riv-hs-skyliner',
    ...
    legs: [
      { mode: 'skyliner', from: 'RIV', to: 'CBR', rideMinutes: 4, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'HS', rideMinutes: 5, accessible: true, walkMinutes: 3 },
    ],
    totalRideMinutes: 9, tags: ['transfer', 'scenic'],
  },
  {
    ...
    legs: [{ mode: 'skyliner', from: 'RIV', to: 'CBR', rideMinutes: 4, accessible: true }],
    totalRideMinutes: 4, tags: ['scenic'],
  },
  {
    id: 'riv-pop-skyliner',
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'RIV', to: 'MK', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'riv-ak-bus',
    from: 'RIV', to: 'AK', name: 'Bus from Riviera Resort',
    legs: [{ mode: 'bus', from: 'RIV', to: 'AK', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'riv-ds-bus',
    from: 'RIV', to: 'DS', name: 'Bus from Riviera Resort',
    legs: [{ mode: 'bus', from: 'RIV', to: 'DS', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    ...
    legs: [
      ...
      { mode: 'walk', from: 'EP', to: 'YC', rideMinutes: 9, accessible: true, walkMinutes: 0 },
    ],
    totalRideMinutes: 18, tags: ['transfer', 'scenic'],
  },
  {
...

  {
    ...
    legs: [
      { mode: 'skyliner', from: 'POP', to: 'CBR', rideMinutes: 5, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 3, tip: 'Transfer at CBR hub. Arrives at EPCOT International Gateway.' },
    ],
    totalRideMinutes: 17, tags: ['transfer', 'scenic'],
  },
  {
    ...
    legs: [
      { mode: 'skyliner', from: 'AOA', to: 'CBR', rideMinutes: 5, accessible: true },
      { mode: 'skyliner', from: 'CBR', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 3 },
    ],
    totalRideMinutes: 17, tags: ['transfer', 'scenic'],
  },
  {
  ...
  },
  {
    ...
    legs: [{ mode: 'skyliner', from: 'POP', to: 'CBR', rideMinutes: 5, accessible: true }],
    totalRideMinutes: 5, tags: ['scenic'],
  },
  {
    id: 'pop-riv-skyliner',
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'POP', to: 'MK', rideMinutes: 28, accessible: true }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  {
    id: 'aoa-mk-bus',
    from: 'AOA', to: 'MK', name: 'Bus from Art of Animation',
    legs: [{ mode: 'bus', from: 'AOA', to: 'MK', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
  {
    id: 'pop-ak-bus',
    from: 'POP', to: 'AK', name: 'Bus from Pop Century',
    legs: [{ mode: 'bus', from: 'POP', to: 'AK', rideMinutes: 18, accessible: true }],
    totalRideMinutes: 18, totalRideRange: [18,38], tags: [],
  },
  {
    id: 'pop-ds-bus',
    from: 'POP', to: 'DS', name: 'Bus from Pop Century',
    legs: [{ mode: 'bus', from: 'POP', to: 'DS', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
...

  {
    ...
    legs: [{ mode: 'walk', from: 'GF', to: 'MK', rideMinutes: 14, accessible: true, tip: 'Usually faster than any transit. Scenic path along Seven Seas Lagoon.' }],
    totalRideMinutes: 14, tags: ['walk_only'],
  },
  {
    id: 'gf-mk-watertaxi',
...

  {
    ...
    legs: [
      { mode: 'walk', from: 'GF', to: 'POLY', rideMinutes: 12, accessible: true, tip: 'Resort Monorail from GF goes the WRONG way (GF→MK→CON→TTC = 11 min). Walking to Poly then TTC is faster.' },
      { mode: 'walk', from: 'POLY', to: 'TTC', rideMinutes: 5, accessible: true, walkMinutes: 0 },
    ],
    totalRideMinutes: 17, tags: ['walk_only'],
  },
  {
  ...
  },
  {
    ...
    legs: [
      { mode: 'walk', from: 'GF', to: 'TTC', rideMinutes: 17, accessible: true, tip: 'Walk GF→POLY (~12 min) + POLY→TTC (~5 min). Then take EPCOT Monorail.' },
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'GF', to: 'HS', rideMinutes: 23, accessible: true }],
    totalRideMinutes: 23, totalRideRange: [23,43], tags: [],
  },
  {
    id: 'gf-ak-bus',
    from: 'GF', to: 'AK', name: 'Bus from Grand Floridian',
    legs: [{ mode: 'bus', from: 'GF', to: 'AK', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, totalRideRange: [22,42], tags: [],
  },
  {
    id: 'gf-ds-bus',
    from: 'GF', to: 'DS', name: 'Bus from Grand Floridian',
    legs: [{ mode: 'bus', from: 'GF', to: 'DS', rideMinutes: 28, accessible: true }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'POLY', to: 'HS', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'poly-ak-bus',
    from: 'POLY', to: 'AK', name: 'Bus from Polynesian Village',
    legs: [{ mode: 'bus', from: 'POLY', to: 'AK', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'poly-ds-bus',
    from: 'POLY', to: 'DS', name: 'Bus from Polynesian Village',
    legs: [{ mode: 'bus', from: 'POLY', to: 'DS', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
...

  {
    ...
    legs: [
      { mode: 'monorail_resort', from: 'CON', to: 'TTC', rideMinutes: 5, accessible: true },
      { mode: 'monorail_epcot', from: 'TTC', to: 'EP', rideMinutes: 12, accessible: true, walkMinutes: 2 },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'CON', to: 'HS', rideMinutes: 23, accessible: true }],
    totalRideMinutes: 23, totalRideRange: [23,43], tags: [],
  },
  {
    id: 'con-ak-bus',
    from: 'CON', to: 'AK', name: 'Bus from Contemporary Resort',
    legs: [{ mode: 'bus', from: 'CON', to: 'AK', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'con-ds-bus',
    from: 'CON', to: 'DS', name: 'Bus from Contemporary Resort',
    legs: [{ mode: 'bus', from: 'CON', to: 'DS', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'water_taxi_red', from: 'WL', to: 'MK', rideMinutes: 8, accessible: true, tip: 'Drops directly at MK gates, not TTC. Scenic, relaxing ride. Recommended.' }],
    totalRideMinutes: 8, tags: ['water', 'scenic'],
  },
  {
    id: 'wl-mk-bus',
    from: 'WL', to: 'MK', name: 'Bus from Wilderness Lodge to Magic Kingdom',
    legs: [{ mode: 'bus', from: 'WL', to: 'MK', rideMinutes: 7, accessible: true, tip: 'Bus drops directly at MK gates (not TTC). Faster ride than the boat, but longer sim wait. Great non-water option.' }],
    totalRideMinutes: 7, totalRideRange: [7,27], tags: [],
  },
  {
    id: 'wl-ep-bus',
    from: 'WL', to: 'EP', name: 'Bus from Wilderness Lodge to EPCOT',
    legs: [{ mode: 'bus', from: 'WL', to: 'EP', rideMinutes: 20, accessible: true, tip: 'Bus is shared with Fort Wilderness. FW boards first on outbound trips. No boat option to EPCOT from WL.' }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'wl-hs-bus',
    from: 'WL', to: 'HS', name: 'Bus from Wilderness Lodge',
    legs: [{ mode: 'bus', from: 'WL', to: 'HS', rideMinutes: 21, accessible: true }],
    totalRideMinutes: 21, totalRideRange: [21,41], tags: [],
  },
  {
    id: 'wl-ak-bus',
    from: 'WL', to: 'AK', name: 'Bus from Wilderness Lodge',
    legs: [{ mode: 'bus', from: 'WL', to: 'AK', rideMinutes: 23, accessible: true }],
    totalRideMinutes: 23, totalRideRange: [23,43], tags: [],
  },
  {
    id: 'wl-ds-bus',
    from: 'WL', to: 'DS', name: 'Bus from Wilderness Lodge',
    legs: [{ mode: 'bus', from: 'WL', to: 'DS', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'wl-con-watertaxi',
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'FW', to: 'HS', rideMinutes: 22, accessible: true, tip: 'Take internal FW bus to Outpost Depot, then external bus to HS.' }],
    totalRideMinutes: 22, totalRideRange: [22,42], tags: [],
  },
  {
    id: 'fw-ak-bus',
    from: 'FW', to: 'AK', name: 'Bus from Fort Wilderness',
    legs: [{ mode: 'bus', from: 'FW', to: 'AK', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'fw-ds-bus',
    from: 'FW', to: 'DS', name: 'Bus from Fort Wilderness',
    legs: [{ mode: 'bus', from: 'FW', to: 'DS', rideMinutes: 23, accessible: true }],
    totalRideMinutes: 23, totalRideRange: [23,43], tags: [],
  },
  {
    id: 'fw-wl-bus',
    from: 'FW', to: 'WL', name: 'Bus from Fort Wilderness to Wilderness Lodge',
    legs: [{ mode: 'bus', from: 'FW', to: 'WL', rideMinutes: 5, accessible: true, tip: 'Short shared bus hop, available anytime.' }],
...

  {
    ...
    legs: [{ mode: 'bus', from: 'AKL', to: 'AK', rideMinutes: 10, accessible: true, tip: 'Short and direct. AKL is very close to Animal Kingdom.' }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },
  {
    id: 'akl-mk-bus',
    from: 'AKL', to: 'MK', name: 'Bus from Animal Kingdom Lodge',
    legs: [{ mode: 'bus', from: 'AKL', to: 'MK', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'akl-ep-bus',
    from: 'AKL', to: 'EP', name: 'Bus from Animal Kingdom Lodge',
    legs: [{ mode: 'bus', from: 'AKL', to: 'EP', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'akl-hs-bus',
    from: 'AKL', to: 'HS', name: 'Bus from Animal Kingdom Lodge',
    legs: [{ mode: 'bus', from: 'AKL', to: 'HS', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'akl-bb-bus',
    from: 'AKL', to: 'BB', name: 'Bus from Animal Kingdom Lodge',
    legs: [{ mode: 'bus', from: 'AKL', to: 'BB', rideMinutes: 15, accessible: true, tip: 'Close proximity. Direct bus.' }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },
  {
    id: 'akl-ds-bus',
    from: 'AKL', to: 'DS', name: 'Bus from Animal Kingdom Lodge',
    legs: [{ mode: 'bus', from: 'AKL', to: 'DS', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'bus', from: 'COR', to: 'AK', rideMinutes: 17, accessible: true, tip: 'Close to AK. One of the faster bus rides from a resort.' }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: [],
  },
  {
    id: 'cor-mk-bus',
    from: 'COR', to: 'MK', name: 'Bus from Coronado Springs',
    legs: [{ mode: 'bus', from: 'COR', to: 'MK', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'cor-ep-bus',
    from: 'COR', to: 'EP', name: 'Bus from Coronado Springs',
    legs: [{ mode: 'bus', from: 'COR', to: 'EP', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'cor-hs-bus',
    from: 'COR', to: 'HS', name: 'Bus from Coronado Springs',
    legs: [{ mode: 'bus', from: 'COR', to: 'HS', rideMinutes: 10, accessible: true }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },
  {
    id: 'cor-bb-bus',
    from: 'COR', to: 'BB', name: 'Bus from Coronado Springs',
    legs: [{ mode: 'bus', from: 'COR', to: 'BB', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },
  {
    id: 'cor-ds-bus',
    from: 'COR', to: 'DS', name: 'Bus from Coronado Springs',
    legs: [{ mode: 'bus', from: 'COR', to: 'DS', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'bus', from: 'ASMo', to: 'MK', rideMinutes: 30, accessible: true }],
    totalRideMinutes: 30, totalRideRange: [30,50], tags: [],
  },
  {
    id: 'asmo-ep-bus',
    from: 'ASMo', to: 'EP', name: 'Bus from All-Star Movies',
    legs: [{ mode: 'bus', from: 'ASMo', to: 'EP', rideMinutes: 19, accessible: true }],
    totalRideMinutes: 19, totalRideRange: [19,39], tags: [],
  },
  {
    id: 'asmo-hs-bus',
    from: 'ASMo', to: 'HS', name: 'Bus from All-Star Movies',
    legs: [{ mode: 'bus', from: 'ASMo', to: 'HS', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'asmo-ak-bus',
    from: 'ASMo', to: 'AK', name: 'Bus from All-Star Movies',
    legs: [{ mode: 'bus', from: 'ASMo', to: 'AK', rideMinutes: 11, accessible: true }],
    totalRideMinutes: 11, totalRideRange: [11,31], tags: [],
  },
  {
    id: 'asmo-bb-bus',
    from: 'ASMo', to: 'BB', name: 'Bus from All-Star Movies',
    legs: [{ mode: 'bus', from: 'ASMo', to: 'BB', rideMinutes: 12, accessible: true, tip: 'Very close to Blizzard Beach. Direct bus.' }],
    totalRideMinutes: 12, totalRideRange: [12,32], tags: [],
  },
  {
    id: 'asmo-ds-bus',
    from: 'ASMo', to: 'DS', name: 'Bus from All-Star Movies',
    legs: [{ mode: 'bus', from: 'ASMo', to: 'DS', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'asmu-mk-bus',
    from: 'ASMu', to: 'MK', name: 'Bus from All-Star Music',
    legs: [{ mode: 'bus', from: 'ASMu', to: 'MK', rideMinutes: 29, accessible: true }],
    totalRideMinutes: 29, totalRideRange: [29,49], tags: [],
  },
  {
    id: 'asmu-ep-bus',
    from: 'ASMu', to: 'EP', name: 'Bus from All-Star Music',
    legs: [{ mode: 'bus', from: 'ASMu', to: 'EP', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: [],
  },
  {
    id: 'asmu-hs-bus',
    from: 'ASMu', to: 'HS', name: 'Bus from All-Star Music',
    legs: [{ mode: 'bus', from: 'ASMu', to: 'HS', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, totalRideRange: [12,32], tags: [],
  },
  {
    id: 'asmu-ak-bus',
    from: 'ASMu', to: 'AK', name: 'Bus from All-Star Music',
    legs: [{ mode: 'bus', from: 'ASMu', to: 'AK', rideMinutes: 10, accessible: true }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },
  {
    id: 'asmu-bb-bus',
    from: 'ASMu', to: 'BB', name: 'Bus from All-Star Music',
    legs: [{ mode: 'bus', from: 'ASMu', to: 'BB', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, totalRideRange: [12,32], tags: [],
  },
  {
    id: 'ass-mk-bus',
    from: 'ASS', to: 'MK', name: 'Bus from All-Star Sports',
    legs: [{ mode: 'bus', from: 'ASS', to: 'MK', rideMinutes: 28, accessible: true, tip: 'Sports is the first stop on All-Stars shared bus, shortest wait.' }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  {
    id: 'ass-ep-bus',
    from: 'ASS', to: 'EP', name: 'Bus from All-Star Sports',
    legs: [{ mode: 'bus', from: 'ASS', to: 'EP', rideMinutes: 28, accessible: true }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  {
    id: 'ass-hs-bus',
    from: 'ASS', to: 'HS', name: 'Bus from All-Star Sports',
    legs: [{ mode: 'bus', from: 'ASS', to: 'HS', rideMinutes: 28, accessible: true }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  {
    id: 'ass-ak-bus',
    from: 'ASS', to: 'AK', name: 'Bus from All-Star Sports',
    legs: [{ mode: 'bus', from: 'ASS', to: 'AK', rideMinutes: 28, accessible: true }],
    totalRideMinutes: 28, totalRideRange: [28,48], tags: [],
  },
  {
    id: 'ass-bb-bus',
    from: 'ASS', to: 'BB', name: 'Bus from All-Star Sports',
    legs: [{ mode: 'bus', from: 'ASS', to: 'BB', rideMinutes: 10, accessible: true }],
    totalRideMinutes: 10, totalRideRange: [10,30], tags: [],
  },
  {
    id: 'ass-ds-bus',
    from: 'ASS', to: 'DS', name: 'Bus from All-Star Sports',
    legs: [{ mode: 'bus', from: 'ASS', to: 'DS', rideMinutes: 22, accessible: true }],
    totalRideMinutes: 22, totalRideRange: [22,42], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'sassagoula_boat', from: 'POFQ', to: 'DS', rideMinutes: 15, accessible: true, tip: 'Scenic river cruise. Popular option for resort guests.' }],
    totalRideMinutes: 15, tags: ['water', 'scenic'],
  },
  {
    id: 'pofq-ds-bus',
    from: 'POFQ', to: 'DS', name: 'Bus from Port Orleans French Quarter',
    legs: [{ mode: 'bus', from: 'POFQ', to: 'DS', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'por-ds-sassagoula',
    from: 'POR', to: 'DS', name: 'Sassagoula River Cruise to Disney Springs',
    legs: [{ mode: 'sassagoula_boat', from: 'POR', to: 'DS', rideMinutes: 20, accessible: true, tip: 'Stops at POFQ first, then Disney Springs. Relaxing option.' }],
    totalRideMinutes: 20, tags: ['water', 'scenic'],
  },
  {
    id: 'por-ds-bus',
    from: 'POR', to: 'DS', name: 'Bus from Port Orleans Riverside',
    legs: [{ mode: 'bus', from: 'POR', to: 'DS', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'pofq-por-boat',
    from: 'POFQ', to: 'POR', name: 'Sassagoula Boat between French Quarter and Riverside',
    legs: [{ mode: 'sassagoula_boat', from: 'POFQ', to: 'POR', rideMinutes: 5, accessible: true }],
    totalRideMinutes: 5, tags: ['water'],
  },
  {
    id: 'pofq-por-walk',
    from: 'POFQ', to: 'POR', name: 'Walk between French Quarter and Riverside (~12 min)',
    legs: [{ mode: 'walk', from: 'POFQ', to: 'POR', rideMinutes: 12, accessible: true }],
    totalRideMinutes: 12, tags: ['walk_only'],
  },
  {
    id: 'pofq-mk-bus',
    from: 'POFQ', to: 'MK', name: 'Bus from Port Orleans French Quarter',
    legs: [{ mode: 'bus', from: 'POFQ', to: 'MK', rideMinutes: 24, accessible: true }],
    totalRideMinutes: 24, totalRideRange: [24,44], tags: [],
  },
  {
    id: 'pofq-ep-bus',
    from: 'POFQ', to: 'EP', name: 'Bus from Port Orleans French Quarter',
    legs: [{ mode: 'bus', from: 'POFQ', to: 'EP', rideMinutes: 14, accessible: true }],
    totalRideMinutes: 14, totalRideRange: [14,34], tags: [],
  },
  {
    id: 'pofq-hs-bus',
    from: 'POFQ', to: 'HS', name: 'Bus from Port Orleans French Quarter',
    legs: [{ mode: 'bus', from: 'POFQ', to: 'HS', rideMinutes: 19, accessible: true }],
    totalRideMinutes: 19, totalRideRange: [19,39], tags: [],
  },
  {
    id: 'pofq-ak-bus',
    from: 'POFQ', to: 'AK', name: 'Bus from Port Orleans French Quarter',
    legs: [{ mode: 'bus', from: 'POFQ', to: 'AK', rideMinutes: 27, accessible: true }],
    totalRideMinutes: 27, totalRideRange: [27,47], tags: [],
  },
  {
    id: 'pofq-tl-via-ds',
    ...
    legs: [
      { mode: 'bus', from: 'POFQ', to: 'DS', rideMinutes: 20, accessible: true },
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'POR', to: 'MK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    id: 'por-ep-bus',
    from: 'POR', to: 'EP', name: 'Bus from Port Orleans Riverside',
    legs: [{ mode: 'bus', from: 'POR', to: 'EP', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'por-hs-bus',
    from: 'POR', to: 'HS', name: 'Bus from Port Orleans Riverside',
    legs: [{ mode: 'bus', from: 'POR', to: 'HS', rideMinutes: 17, accessible: true }],
    totalRideMinutes: 17, totalRideRange: [17,37], tags: [],
  },
  {
    id: 'por-ak-bus',
    from: 'POR', to: 'AK', name: 'Bus from Port Orleans Riverside',
    legs: [{ mode: 'bus', from: 'POR', to: 'AK', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
...

  {
    ...
    legs: [{ mode: 'sassagoula_boat', from: 'OKW', to: 'DS', rideMinutes: 20, accessible: true, tip: 'Green flag boat. Scenic river cruise option.' }],
    totalRideMinutes: 20, tags: ['water', 'scenic'],
  },
  {
    id: 'okw-ds-bus',
    from: 'OKW', to: 'DS', name: 'Bus from Old Key West',
    legs: [{ mode: 'bus', from: 'OKW', to: 'DS', rideMinutes: 20, accessible: true }],
    totalRideMinutes: 20, totalRideRange: [20,40], tags: [],
  },
  {
    id: 'ss-ds-sassagoula',
    from: 'SS', to: 'DS', name: 'Sassagoula River Cruise to Disney Springs',
    legs: [{ mode: 'sassagoula_boat', from: 'SS', to: 'DS', rideMinutes: 15, accessible: true, tip: 'Blue flag, shortest Sassagoula run. SS is adjacent to DS.' }],
    totalRideMinutes: 15, tags: ['water', 'scenic'],
  },
  {
    id: 'ss-ds-walk',
    from: 'SS', to: 'DS', name: 'Walk to Disney Springs (~17 min)',
    legs: [{ mode: 'walk', from: 'SS', to: 'DS', rideMinutes: 17, accessible: true, tip: 'Saratoga Springs is right next to Disney Springs. Easy walk.' }],
    totalRideMinutes: 17, tags: ['walk_only'],
  },
  {
    id: 'ss-ds-bus',
    from: 'SS', to: 'DS', name: 'Bus from Saratoga Springs',
    legs: [{ mode: 'bus', from: 'SS', to: 'DS', rideMinutes: 15, accessible: true }],
    totalRideMinutes: 15, totalRideRange: [15,35], tags: [],
  },
  {
    id: 'okw-tl-via-ds',
    ...
    legs: [
      { mode: 'bus', from: 'OKW', to: 'DS', rideMinutes: 20, accessible: true },
      { mode: 'bus', from: 'DS', to: 'TL', rideMinutes: 10, accessible: true, walkMinutes: 5 },
    ],
    totalRideMinutes: 30, totalRideRange: [30,55], tags: ['transfer'],
  },
  {
    ...
    legs: [
      { mode: 'bus', from: 'SS', to: 'DS', rideMinutes: 15, accessible: true },
      { mode: 'bus', from: 'DS', to: 'TL', rideMinutes: 10, accessible: true, walkMinutes: 5 },
    ],
  ...
  },
  {
    ...
    legs: [{ mode: 'bus', from: 'OKW', to: 'MK', rideMinutes: 26, accessible: true }],
    totalRideMinutes: 26, totalRideRange: [26,46], tags: [],
  },
  {
    id: 'okw-ep-bus',
    from: 'OKW', to: 'EP', name: 'Bus from Old Key West',
    legs: [{ mode: 'bus', from: 'OKW', to: 'EP', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'okw-hs-bus',
    from: 'OKW', to: 'HS', name: 'Bus from Old Key West',
    legs: [{ mode: 'bus', from: 'OKW', to: 'HS', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'okw-ak-bus',
    from: 'OKW', to: 'AK', name: 'Bus from Old Key West',
    legs: [{ mode: 'bus', from: 'OKW', to: 'AK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    id: 'ss-mk-bus',
    from: 'SS', to: 'MK', name: 'Bus from Saratoga Springs',
    legs: [{ mode: 'bus', from: 'SS', to: 'MK', rideMinutes: 27, accessible: true }],
    totalRideMinutes: 27, totalRideRange: [27,47], tags: [],
  },
  {
    id: 'ss-ep-bus',
    from: 'SS', to: 'EP', name: 'Bus from Saratoga Springs',
    legs: [{ mode: 'bus', from: 'SS', to: 'EP', rideMinutes: 13, accessible: true }],
    totalRideMinutes: 13, totalRideRange: [13,33], tags: [],
  },
  {
    id: 'ss-hs-bus',
    from: 'SS', to: 'HS', name: 'Bus from Saratoga Springs',
    legs: [{ mode: 'bus', from: 'SS', to: 'HS', rideMinutes: 16, accessible: true }],
    totalRideMinutes: 16, totalRideRange: [16,36], tags: [],
  },
  {
    id: 'ss-ak-bus',
    from: 'SS', to: 'AK', name: 'Bus from Saratoga Springs',
    legs: [{ mode: 'bus', from: 'SS', to: 'AK', rideMinutes: 25, accessible: true }],
    totalRideMinutes: 25, totalRideRange: [25,45], tags: [],
  },
  {
    id: 'okw-bb-via-ak',
    ...
    legs: [
      { mode: 'bus', from: 'OKW', to: 'AK', rideMinutes: 25, accessible: true },
      { mode: 'bus', from: 'AK', to: 'BB', rideMinutes: 15, accessible: true, walkMinutes: 5 },
    ],
    totalRideMinutes: 40, totalRideRange: [40,65], tags: ['transfer'],
  },
